...
class OracleHandler(BaseHandler):
	def get(self, question, answer_string, artist):
		...
		og_url="http://www.infiniteglitch.net/share_oracle/"+tornado.escape.url_escape(question)+"/"+tornado.escape.url_escape(answer.couplet['couplet'][0])+"/"+tornado.escape.url_escape(answer.couplet['couplet'][1])+"/"+tornado.escape.url_escape(answer.couplet['artist'].lstrip())
		popular_words = oracle.popular_words(90)
		random.shuffle(popular_words)
